...
export async function generateMetadata({ params }: EsportBettingProps): Promise<Metadata> {
...
export default function EsportBettingPage({ params }: EsportBettingProps) {
  const sport = sports.find((s) => s.slug === params.slug && s.category === 'esports');
  if (!sport) {
    notFound();
  }
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-400">
            Price shopping, map leans, and prop angles for {sport.name}.
          </p>
        </div>
