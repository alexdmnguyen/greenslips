...
export const metadata: Metadata = {
  title: 'Esports Daily Picks - SAMBO SENTRAL',
  description: 'Daily picks focused on esports matchups.',
};

const esportsSet = new Set(
  sports.filter((s) => s.category === 'esports').map((s) => s.name)
);

const esportsPicks = picks.filter((pick) => esportsSet.has(pick.sport));

export default function EsportsPicksPage() {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400">
            Hand-picked plays for VALORANT, CS2, League of Legends, and more.
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          {esportsPicks.length === 0 && (
            <div className="text-center text-gray-400">
              No esports picks available yet. Check back soon!
            </div>
          )}
        </div>
      </div>
