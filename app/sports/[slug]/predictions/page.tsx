...
export async function generateMetadata({ params }: SportPredictionsProps): Promise<Metadata> {
...
export default function SportPredictionsPage({ params }: SportPredictionsProps) {
  const sport = sports.find((s) => s.slug === params.slug && s.category === 'sports');
  if (!sport) {
    notFound();
  }
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-400">
            Projections, matchup edges, and calls tailored to {sport.name}.
          </p>
        </div>
