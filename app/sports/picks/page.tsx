...
export const metadata: Metadata = {
  title: 'Sports Daily Picks - SAMBO SENTRAL',
  description: 'Daily picks focused on traditional sports matchups.',
};

const sportsSet = new Set(
  sports.filter((s) => s.category === 'sports').map((s) => s.name)
);

const sportsPicks = picks.filter((pick) => sportsSet.has(pick.sport));
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400">
            Expert angles for baseball, basketball, tennis, and more.
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          {sportsPicks.length === 0 && (
            <div className="text-center text-gray-400">
              No sports picks available yet. Check back soon!
            </div>
          )}
        </div>
      </div>
